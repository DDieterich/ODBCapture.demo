...
@"../grb_linked_install_scripts/summarize_install_log.sql" "ss_tdat"
...
@"../grb_linked_install_scripts/list_invalids.sql" "'HR','OE','PM'"
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/db_build_junit_report.sql" "'HR','OE','PM'"
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/log_files_junit_report.sql" "ss_tdat"
spool off
set termout on
set feedback on
