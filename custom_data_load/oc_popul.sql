...
INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('hardware1', 'monitors', 11,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 11) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('hardware2', 'printers', 12,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 12) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('hardware3', 'harddisks', 13,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 13) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('hardware4', 'memory components/upgrades', 14,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
...
INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('hardware6', 'keyboards, mouses, mouse pads', 16,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
...
INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('software1', 'spreadsheet software', 21,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 21) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('software2', 'word processing software', 22,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 22) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('software3', 'database software', 23,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 23) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('software4', 'operating systems', 24,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 24) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('software5', 'software development tools (including languages)', 25,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 25) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('software6', 'miscellaneous software', 29,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 29) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('office1', 'capitalizable assets (desks, chairs, phones ...)', 31,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
...
INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('office3', 'manuals, other books', 33,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 33) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.leaf_category_typ('office4', 'miscellaneous office supplies', 39,
  CAST(MULTISET(SELECT o.product_id
    FROM oe.oc_product_information o
    WHERE o.category_id = 39) as oe.product_ref_list_typ))) ;

INSERT INTO oe.categories_tab
  VALUES (oe.composite_category_typ('hardware', 'computer hardware and peripherals', 10,
...
INSERT INTO oe.categories_tab
  VALUES (oe.composite_category_typ('software', 'computer software', 20,
  CAST(MULTISET(SELECT REF(g)
    FROM oe.categories_tab g
...
INSERT INTO oe.categories_tab
  VALUES (oe.composite_category_typ('office equipment', 'office furniture and supplies', 30,
  CAST(MULTISET(SELECT REF(g)
    FROM oe.categories_tab g
